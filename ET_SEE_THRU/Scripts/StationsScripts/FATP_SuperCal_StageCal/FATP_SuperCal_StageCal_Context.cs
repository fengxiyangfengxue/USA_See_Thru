...

{
    ...
    public class SuperCalStageCal_Context
    {

        public SuperCalStageCal_Context()
        {
            Reset();
        }
    ...
    public class TcIntStageCal
    {
        ...
        public TcIntStageCal(int port = Port)
        {
            this.port = port;
            this.host = "localhost";
        ...
        public (bool, string) ClientCommunicate(string cliData, string end = "ok", int timeout = 100)
        {
            lock (lockObj)
            {
