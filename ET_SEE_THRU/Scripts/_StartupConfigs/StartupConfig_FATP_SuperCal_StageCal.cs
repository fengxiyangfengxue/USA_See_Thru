...
{
    public class StartupConfig_FATP_SuperCal_StageCal: IStartupConfig
    {
        public StartupConfig_FATP_SuperCal_StageCal(TestConfig config)
        {
            Factory = FACTORY_TYPE.GTK;
            LineType = LINE_TYPE.FATP;
            Station = TEST_STATION.FATP_SuperCal_StageCal;
            IsPrintLimits = false;
